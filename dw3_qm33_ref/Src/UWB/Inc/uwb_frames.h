...
typedef struct
{
    ...
    uint8_t dwh;                     /*  12 - Qorvo Blink Header: 0x01: SENSOR DATA TYPE 1. */
                                     /*  [According to ISO 24730-62, this octet and any subsequent data can only be interpreted if we identify from the Tag ID field that this is a Qorvo tag]. */
    uint8_t dwp[27];                 /*  13 - 39 Qorvo Blink Payload � Defined below for Sensor Data Type 1. */
