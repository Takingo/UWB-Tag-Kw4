 ...
 * @file      ble_qnis.c
 *
 * @brief     Interface for QNIS (Qorvo NI Service).
 *
...
#define BLE_QNIS_DEF(_name, _qnis_max_clients)                                                                            \
    BLE_LINK_CTX_MANAGER_DEF(CONCAT_2(_name, _link_ctx_storage), (_qnis_max_clients), sizeof(ble_qnis_client_context_t)); \
    static ble_qnis_t _name = {                                                                                           \
        .p_link_ctx_storage = &CONCAT_2(_name, _link_ctx_storage)};                                                       \
    NRF_SDH_BLE_OBSERVER(_name##_obs, BLE_QNIS_BLE_OBSERVER_PRIO, ble_qnis_on_ble_evt, &_name)
